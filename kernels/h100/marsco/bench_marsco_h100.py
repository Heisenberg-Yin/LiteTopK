...
32768}. LiteTopK runs the flat-batch mode of litetopk_sm90::fused_ip_sparse_h100
...
def main():
    ...
    print(f"  LiteTopK SM90 fused        : {t_ours:.4f} ms   speedup {t_base / t_ours:.2f}x", flush=True)

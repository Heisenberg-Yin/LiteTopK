// Compile-only check for the SM90 port: instantiate the kernel template at
// the production shape (GLM-5 H=32 D=128, BLOCK_Q=4, BLOCK_KV=128, 4 KV
...
#ifdef CHECK_GATE4_TOO
// (built twice: once default gate, once -DDSA_BUCKET_GATE4)
#endif

...
from flashlib.primitives.kmeans.torch_fallback import euclid_assign_torch_native_chunked, batch_kmeans_Euclid_torch_native
import torch
...
class KMeans:
    ...
    def predict(self, data: torch.Tensor) -> torch.LongTensor:
        ...
        if self.use_triton:
            ...
            # Call PyTorch assignment fallback (x²-free signature).
